...
mod_alcoCintuInteraccion = glm(acturismonum~conductaalcohol+conductacinturon+conductaalcohol:conductacinturon+offset(loganyos), family=quasipoisson, data=train)
mod_alcoCintu = glm(acturismonum~conductaalcohol+conductacinturon+offset(loganyos), family=quasipoisson, data=train)
...
mod_alcoMovilInteraccion = glm(acturismonum~conductaalcohol+conductamovil+conductaalcohol:conductamovil+offset(loganyos), family=quasipoisson, data=train)
mod_alcoMovil = glm(acturismonum~conductaalcohol+conductamovil+offset(loganyos), family=quasipoisson, data=train)
...
mod_cintuMovilInteraccion = glm(acturismonum~conductacinturon+conductamovil+conductacinturon:conductamovil+offset(loganyos), family=quasipoisson, data=train)
mod_cintuMovil = glm(acturismonum~conductacinturon+conductamovil+offset(loganyos), family=quasipoisson, data=train)
...
## MODELO TRIVARIANTE
mod_triConducta = glm(acturismonum~conductacinturon+conductamovil+conductaalcohol+offset(loganyos), family=quasipoisson, data=train)
